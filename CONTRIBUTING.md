...
documents](https://datatracker.ietf.org/wg/marnew/documents/) and [mailing
list discussion](https://mailarchive.ietf.org/arch/browse/marnew/). If you're
...
([info](https://www.ietf.org/mailman/listinfo/marnew)). This will ensure that
