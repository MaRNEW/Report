...
- SPUD [SPUD]: a proposed, UDP-based encapsulation protocol to allow explicit cooperation with middleboxes while using new, encrypted transport protocols.
...
- AQM [AQM] and ECN [RFC3168] deployments: queuing and congestion management methods have existed for sometime in the form of AQM, ECN and others which can help the transport and Internet layer adapt to congestion faster.
